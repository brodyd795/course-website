        ...
        <div className="container">
          <div className="row align-self-center text-center text-md-left">
            <div className="col-12">
              <h1>
                <a
                  href="https://brody.linguatorium.com/courses"
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto">
            ...
            >
              <a
                className="nav-link"
                href="https://brody.linguatorium.com/courses/assignments"
              >
                Assignments
              </a>
            </li>
            ...
            >
              <a
                className="nav-link"
                href="https://brody.linguatorium.com/courses/sandbox"
              >
                Sandbox
              </a>
            </li>
            ...
            >
              <a
                className="nav-link"
                href="https://brody.linguatorium.com/courses/grades"
              >
                Grades
              </a>
            </li>
            ...
            >
              <a
                className="nav-link"
                href="https://brody.linguatorium.com/courses/attendance"
              >
                Attendance
              </a>
            </li>
            ...
            >
              <a
                className="nav-link"
                href="https://brody.linguatorium.com/courses/blackbox"
              >
                Black Box
              </a>
            </li>
            ...
            >
              <a
                className="nav-link"
                href="https://brody.linguatorium.com/courses/appointment"
              >
                Appointment
              </a>
            </li>
